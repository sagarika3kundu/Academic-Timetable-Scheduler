...
public class Export extends javax.swing.JFrame {
    ...
    private static final FileNameExtensionFilter fil = new FileNameExtensionFilter("*.csv","csv");
       /**
     * Creates new form Export
     */
    public Export(DisplayManager mymr) {
        this.mgr=mymr;
        initComponents();
    ...
    private void jFileChooser1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooser1ActionPerformed
        ...
        jFileChooser1.setFileFilter(fil);
        System.out.println(jFileChooser1.getCurrentDirectory());
        if(evt.getActionCommand().equals("ApproveSelection")) //Using action listener
        {
            mgr.exitFRS();
